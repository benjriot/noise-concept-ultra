  ...
  return (
    <section id="problem" className="relative bg-noise-yellow overflow-hidden diagonal-line tear-bottom" style={{ '--tear-color': '#000' }}>
      <div className="px-6 md:px-12 lg:px-16 xl:px-20 py-20 md:py-32 max-w-[1400px] mx-auto text-center">
        ...
        <h2 className="font-brexter text-noise-black text-[10vw] md:text-[5.5vw] uppercase leading-[0.88] tracking-tight mb-12 md:mb-16 reveal reveal-glitch rgb-split" data-text="12+ APPS. JUST TO FUNCTION.">12+ APPS.<br />JUST TO FUNCTION.</h2>
